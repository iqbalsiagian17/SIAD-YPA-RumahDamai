        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    @endif
                    <a href="{{ route('direktur.orangTuaWali.create') }}" class="btn btn-success mb-3">Tambah Orang Tua/Wali</a>
                </div>
                        ...
                        <tbody>
                            @forelse ($orangtuawaliList as $orangtuawali)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('direktur.orangTuaWali.show', $orangtuawali->id) }}"
                                            class="btn btn-info">Detail</a>
                                        <a href="{{ route('direktur.orangTuaWali.edit', $orangtuawali->id) }}"
                                            class="btn btn-warning">Edit</a>
                                        <form method="POST" id="deleteForm{{ $orangtuawali->id }}" class="d-inline"
                                            action="{{ route('direktur.orangTuaWali.destroy', $orangtuawali->id) }}">
                                            @csrf
                                            @method('DELETE')
