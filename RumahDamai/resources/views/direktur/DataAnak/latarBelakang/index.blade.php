        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    @endif
                    <a href="{{ route('direktur.latarBelakang.create') }}" class="btn btn-success mb-3">Tambah Latar Belakang Anak</a>
                </div>
                        ...
                        <tbody>
                            @forelse ($latarBelakangList as $latarBelakang)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('direktur.latarBelakang.show', $latarBelakang->id) }}" class="btn btn-info">Detail</a>
                                        <a href="{{ route('direktur.latarBelakang.edit', $latarBelakang->id) }}" class="btn btn-warning">Edit</a>
                                        <!-- Tambahkan tag form untuk hapus -->
                                        <form method="POST" id="deleteForm{{ $latarBelakang->id }}" class="d-inline"
                                            action="{{ route('direktur.latarBelakang.destroy', $latarBelakang->id) }}">
                                            @csrf
                                            @method('DELETE')
